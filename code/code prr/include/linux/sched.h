...
#define SCHED_FIFO		1
#define SCHED_RR		2
#define SCHED_WRR       6//newly-add 
#define SCHED_PRR     	7//prr
...
struct task_struct {
	...
	struct sched_wrr_entity wrr;//newly-add
	struct sched_prr_entity prr;//prr
